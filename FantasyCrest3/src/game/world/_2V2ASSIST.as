package game.world
{
   ...
   public class _2V2ASSIST extends AssistWorld
   {
      
      public function _2V2ASSIST(mapName:String, toName:String)
      {
      ...
      override public function initRole() : void
      {
         ...
         {
            outRole(getRoleList()[1]);
            outRole(getRoleList()[2]);
            createChangeTipsView();
         },3);
      }
   }
}
